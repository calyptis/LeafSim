...
def get_stylised_similar_cars_table(
    ...
    df_to_show = (
        ...
        .assign(
            ...
            # Do the same as above for the other numeric attributes
    ...
    df_to_show = (
        df_to_show
        [top_n_features + ["similarity", target_col]]
        .style
        .format(formatting)
...
def get_similarity_plots(
    ...
    sns.lineplot(
        ...
        ci="sd", label="$\mu$ and $\sigma$ of car's prices in training set", ax=ax
    )
